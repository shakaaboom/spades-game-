...
import RealRoom from "@/components/game/RealRoom";

export default function RealGamePage() {
        ...
        <div className="container mx-auto py-2 px-2 md:px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="h-7">
              ...
              <span className="text-xs">Solo Game</span>
            </Badge>
          </div>
        </div>
      </div>
      <div className="container mx-auto py-2 px-2 md:px-6">
        <RealRoom session={session} wager={10} />
      </div>
    </>
  );
}
