    ...
    <Tabs defaultValue="all" className="w-full">
      <div className="flex flex-wrap items-center justify-between gap-2 mb-4 md:mb-6">
        ...
        <div>
          ...
          <select
            id="wagerFilter"
            className="border border-border dark:border-gray-400 rounded-md p-2 bg-card text foreground dark:bg-card-dark dark:text-white shadow-md transition-colors"
            value={wagerFilter || ""}
